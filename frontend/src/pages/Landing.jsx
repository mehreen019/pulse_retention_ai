    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="relative">
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100 h-full">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Automated Campaigns</h3>
              <p className="text-gray-600">
        ...
        <div className="flex justify-center">
          <div className="bg-gradient-to-r from-pink-50 via-purple-50 to-blue-50 rounded-2xl p-8 md:p-12 max-w-4xl w-full">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="text-center flex-1">
                <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-3 shadow-md">
                  <span className="text-3xl">📊</span>
                </div>
                <p className="text-sm font-semibold text-gray-700">Data Integration</p>
              </div>
              ...
              <div className="text-center flex-1">
                ...
                <p className="text-sm font-semibold text-gray-700">Targeted Action</p>
              </div>
            </div>
          </div>
        </div>
